  ...
  "01_first-folder": {
    ...
    build: [
      ...
      { type: "create-file", path: "${ws}/CLAUDE.md",
        ...
        check: {
          q: "Why does that one file change how Claude responds?",
          options: [
            { t: "It carries who you are, what the project is, and what good looks like — so Claude stops starting from zero.", correct: true },
            { t: "It gives Claude more processing power for your questions." },
            { t: "Claude only works properly when your files are in markdown format." },
            { t: "It unlocks a special project mode inside Claude." }
          ],
          explain: "It's about context, not power. The file tells Claude who you are, what you're building, and what good work looks like — so you stop re-explaining it every chat."
        } },
      ...
      { type: "create-file", path: "${ws}/CONTEXT.md",
        ...
        xp: 10,
        check: {
          q: "You'll have three of these files. What's the split between them?",
          options: [
            { t: "CLAUDE.md is who you are, CONTEXT.md is the project right now, REFERENCES.md is background.", correct: true },
            { t: "They're three backups of the same information." },
            { t: "One is for Claude Code, one for Desktop, one for the terminal." },
            { t: "The names don't matter — Claude reads them all the same way." }
          ],
          explain: "CLAUDE.md carries who you are, CONTEXT.md carries the project, REFERENCES.md carries background. Three jobs, three files."
        } }
    ],
    checkin: {
  ...
  "02_prompt-structure": {
    ...
    build: [
      { type: "create-folder", parent: "${ws}", name: "prompts",
        ...
        xp: 10,
        check: {
          q: "Identity is the part most people skip. What does leaving it out cost you?",
          options: [
            { t: "A more generic output — you never told Claude what role to write from.", correct: true },
            { t: "Nothing — Claude assigns itself the right role automatically." },
            { t: "The prompt fails to send." },
            { t: "Claude asks you to add it before answering." }
          ],
          explain: "Identity shapes the vocabulary, depth, and assumptions. Skip it and you get a capable stranger writing blind."
        } },
  ...
  "03_full-walkthrough": {
    ...
    build: [
      { type: "edit-file", path: "${ws}/CLAUDE.md", mode: "append", button: "Open CLAUDE.md",
        ...
        xp: 20,
        check: {
          q: "You just built the routing table. What breaks without it?",
          options: [
      ...
      { type: "edit-file", path: "${ws}/CLAUDE.md", mode: "append", button: "Open CLAUDE.md",
        ...
        check: {
          q: "Why split work into areas at all? What does it buy you?",
          options: [
            { t: "The context window is finite — separating work means Claude only loads what the task needs.", correct: true },
            { t: "Tokens cost money, and folders are free." },
            { t: "More folders means Claude can use more tokens at once." },
            { t: "It only matters for code projects." }
          ],
          explain: "Dump everything in one place and Claude reads your video notes while writing your blog post. Folders split the work so only the relevant part loads."
        } }
    ],
    checkin: {
  ...
  "04_customize": {
    ...
    build: [
      { type: "picker", storeAs: "04-use-case", eyebrow: "Your work",
        ...
        check: {
          q: "Across all three examples — what actually changes, and what stays put?",
          options: [
    ...
    build: [
      { type: "open-file", path: "${ws}/CLAUDE.md",
        ...
        check: {
          ...
          options: [
            { t: "The routing signal gets buried in noise, and Claude burns tokens on background — the extra belongs in workspace CONTEXT.md files.", correct: true },
      ...
      { type: "edit-file", path: "${ws}/${chosen:03-room}/CONTEXT.md", mode: "append", button: "Open CONTEXT.md",
        ...
        xp: 10,
        check: {
          q: "A context file spends 30 lines on Claude's personality and 2 on the project. Why does it underperform?",
          options: [
      ...
      { type: "create-file", path: "${ws}/self-audit.md",
        ...
        check: {
          q: "Someone spends a whole weekend building six workspaces before running one task. What does the lesson predict?",
          options: [
  ...
  "07_in-practice": {
    ...
    build: [
      { type: "seed-files",
        ...
        xp: 5,
        check: {
          q: "15 meeting notes, one summary. Why does Claude Code finish in 90 seconds what takes an hour by hand in Desktop?",
          options: [
  ...
  "08_thinking-partner": {
    ...
    build: [
      ...
      { type: "claude-chat",
        ...
        check: {
          q: "Fifteen minutes of planning in Desktop before building in Code — what does that save you?",
          options: [
  ...
  "10_where-this-goes": {
    ...
    build: [
      { type: "create-folder", parent: "${ws}", name: "player-choice", storeAs: "10-area",
        ...
        xp: 10,
        check: {
          q: "Why does task routing matter more as you scale up?",
          options: [
